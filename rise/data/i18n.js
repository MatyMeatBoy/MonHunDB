...
const I18N = {
  ui: {
    es: {
      ...
      speciesBack: "← Volver al inicio",
      speciesGenUnknown: "Generación sin confirmar",
      speciesCountLabel: (n) => `${n} monstruo${n === 1 ? "" : "s"} en nuestra base de datos`,
    ...
    en: {
      ...
      speciesBack: "← Back to home",
      speciesGenUnknown: "Generation unconfirmed",
      speciesCountLabel: (n) => `${n} monster${n === 1 ? "" : "s"} in our database`,
