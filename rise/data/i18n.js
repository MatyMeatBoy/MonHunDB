...
const I18N = {
  ui: {
    es: {
      ...
      hubSubtitle: "Elegí un juego para explorar su guía completa",
      hubEnter: "Entrar →",
      ...
      newsV04Tag: "v0.4",
      newsV04Title: "Estructura multi-página y galería de armaduras completa",
      newsV04Text: "Reescribimos todo el sitio como páginas HTML reales (adiós a la app de una sola página que generaba bugs). Ahora cada juego tiene su carpeta independiente, y cada sección su propia URL. La galería de armaduras pasó de 62 sets a 223, con imágenes locales para todos y habilidades en español. También arreglamos el buscador de monstruos pequeños, mejoramos el buscador principal, y eliminamos todos los desplegables molestos de materiales.",
      newsV04Bullets: [
        "Estructura multi-página: hub con selector de juegos, Rise en su propia carpeta, URLs reales por sección (navegación limpia sin bugs de estado).",
        "Galería de armaduras: 223 sets con imágenes locales y habilidades en español. Sets base, S y X de todas las familias.",
        "Buscador principal: ahora al hacer clic se convierte en campo de texto sin barra duplicada; Enter selecciona el primer resultado.",
        "Monstruos pequeños: búsqueda arreglada, encabezados de sección inteligentes.",
        "Materiales visibles directamente, sin desplegables. Tooltips en columna Dropeo (Robo con Felyne).",
        "Skills de armadura en español, ícono de defensa, formato de drops unificado entre grandes y pequeños.",
      ],
    ...
    en: {
      ...
      newsV04Tag: "v0.4",
      newsV04Title: "Multi-page structure and complete armor gallery",
      newsV04Text: "Rewrote the entire site as real HTML pages (goodbye single-page app that caused bugs). Each game now has its own independent folder, and each section has its own URL. The armor gallery went from 62 to 223 sets, all with local images and Spanish skill names. Also fixed small monster search, improved the main search bar, and removed all annoying material dropdowns.",
      newsV04Bullets: [
        "Multi-page structure: hub with game selector, Rise in its own folder, real URLs per section (clean navigation without state bugs).",
        "Armor gallery: 223 sets with local images and Spanish skill names. Base, S and X variants for every family.",
        "Main search bar: now transforms into a text field on click without a duplicate bar; Enter selects the first visible result.",
        "Small monsters: search fixed, smart section headings.",
        "Materials shown directly, no dropdowns. Tooltips on Dropped column (Pilfer with Felyne).",
        "Armor skills in Spanish, defense icon, unified drop format for large and small monsters.",
      ],
