...
// even though each game only uses a subset of the 14 real weapon types.
...
const MONSTER_3D_MODELS = {
  ...
  "Apex Rathalos": "data/models/apex-rathalos.glb",
  "Apex Rathian": "data/models/apex-rathian.glb",
  "Apex Zinogre": "data/models/apex-zinogre.glb",
  ...
  "Violet Mizutsune": "data/models/violet-mizutsune.glb",
  "Lucent Nargacuga": "data/models/lucent-nargacuga.glb",
  "Seething Bazelgeuse": "data/models/seething-bazelgeuse.glb",
  "Chaotic Gore Magala": "data/models/chaotic-gore-magala.glb",
  "Scorned Magnamalo": "data/models/scorned-magnamalo.glb",
  "Primordial Malzeno": "data/models/primordial-malzeno.glb",
  "Furious Rajang": "data/models/furious-rajang.glb",
  "Risen Chameleos": "data/models/risen-chameleos.glb",
  "Risen Kushala Daora": "data/models/risen-kushala-daora.glb",
  "Risen Shagaru Magala": "data/models/risen-shagaru-magala.glb",
  "Risen Teostra": "data/models/risen-teostra.glb",
  "Blood Orange Bishaten": "data/models/blood-orange-bishaten.glb",
  "Flaming Espinas": "data/models/flaming-espinas.glb",
  "Pyre Rakna-Kadaki": "data/models/pyre-rakna-kadaki.glb",
  "Aurora Somnacanth": "data/models/aurora-somnacanth.glb",
  "Amatsu": "data/models/amatsu.glb",
  "Anjanath": "data/models/anjanath.glb",
  "Arzuros": "data/models/arzuros.glb",
  "Astalos": "data/models/astalos.glb",
  "Barioth": "data/models/barioth.glb",
  "Barroth": "data/models/barroth.glb",
  "Basarios": "data/models/basarios.glb",
  "Bazelgeuse": "data/models/bazelgeuse.glb",
  "Bishaten": "data/models/bishaten.glb",
  "Chameleos": "data/models/chameleos.glb",
  "Daimyo Hermitaur": "data/models/daimyo-hermitaur.glb",
  "Diablos": "data/models/diablos.glb",
  "Espinas": "data/models/espinas.glb",
  "Gaismagorm": "data/models/gaismagorm.glb",
  "Garangolm": "data/models/garangolm.glb",
  "Gore Magala": "data/models/gore-magala.glb",
  "Goss Harag": "data/models/goss-harag.glb",
  "Great Baggi": "data/models/great-baggi.glb",
  "Great Izuchi": "data/models/great-izuchi.glb",
  "Great Wroggi": "data/models/great-wroggi.glb",
  "Jyuratodus": "data/models/jyuratodus.glb",
  "Khezu": "data/models/khezu.glb",
  "Kulu-Ya-Ku": "data/models/kulu-ya-ku.glb",
  "Kushala Daora": "data/models/kushala-daora.glb",
  "Lagombi": "data/models/lagombi.glb",
  "Lunagaron": "data/models/lunagaron.glb",
  "Magnamalo": "data/models/magnamalo.glb",
  "Malzeno": "data/models/malzeno.glb",
  "Mizutsune": "data/models/mizutsune.glb",
  "Nargacuga": "data/models/nargacuga.glb",
  "Pukei-Pukei": "data/models/pukei-pukei.glb",
  "Rajang": "data/models/rajang.glb",
  "Rakna-Kadaki": "data/models/rakna-kadaki.glb",
  "Rathalos": "data/models/rathalos.glb",
  "Rathian": "data/models/rathian.glb",
  "Royal Ludroth": "data/models/royal-ludroth.glb",
  "Seregios": "data/models/seregios.glb",
  "Shagaru Magala": "data/models/shagaru-magala.glb",
  "Shogun Ceanataur": "data/models/shogun-ceanataur.glb",
  "Somnacanth": "data/models/somnacanth.glb",
  "Teostra": "data/models/teostra.glb",
  "Tetranadon": "data/models/tetranadon.glb",
  "Thunder Serpent Narwa": "data/models/thunder-serpent-narwa.glb",
  "Tigrex": "data/models/tigrex.glb",
  "Tobi-Kadachi": "data/models/tobi-kadachi.glb",
  ...
  "Zinogre": "data/models/zinogre.glb",
  ...
  "Ceanataur": "data/models/ceanataur.glb",
  "Rhenoplos": "data/models/rhenoplos.glb",
  "Bnahabra": "data/models/bnahabra.glb",
  "Altaroth": "data/models/altaroth.glb",
  "Gajau": "data/models/gajau.glb",
  "Jaggi": "data/models/jaggi.glb",
  "Jaggia": "data/models/jaggia.glb",
  "Baggi": "data/models/baggi.glb",
  "Delex": "data/models/delex.glb",
  "Ludroth": "data/models/ludroth.glb",
  "Uroktor": "data/models/uroktor.glb",
  "Slagtoth": "data/models/slagtoth.glb",
  "Gargwa": "data/models/gargwa.glb",
  "Jagras": "data/models/jagras.glb",
  "Wroggi": "data/models/wroggi.glb",
  "Zamite": "data/models/zamite.glb",
  "Kestodon": "data/models/kestodon.glb",
  "Bombadgy": "data/models/bombadgy.glb",
  "Izuchi": "data/models/izuchi.glb",
...
function rankElementColumns(hitzones) {
  ...
  // the whole body (e.g. Gore Magala: Dragon peaks at 25 on one part but
  // sums to 80 total, while Fire never exceeds 20 per part but sums to 125).
  const sumByKey = {};
