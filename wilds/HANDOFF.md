...
- 🟢 **Habilidades por pieza**: 587/690 piezas matcheadas desde las páginas de `armor-series`; las 103 restantes no tienen match exacto en Kiranico y conservan sus datos vacíos sin inventar. Los resúmenes de set quedaron en 154/159: se reconstruyeron 20 sets que no tenían resumen usando únicamente sus piezas ya matcheadas.
