const GROUP_OVERRIDES = {
  ...
  "Guardian Arkveld": "Arkveld",
  "Guardian Doshaguma": "Doshaguma",
  "Guardian Ebony Odogaron": "Ebony Odogaron",
  "Guardian Fulgur Anjanath": "Fulgur Anjanath",
  "Guardian Rathalos": "Rathalos",
  "Guardian Zoh Shia": "Zoh Shia",
...
const ARMOR_SET_HIDDEN = new Set(["Swallow", "Sonic", "Floral", "Buff", "Buff Body", "Elgado", "Akuma's", "Arlow", "Azure", "Azure Age", "Blossom", "Dragonsbane", "Fall", "Fiorayne", "Formal Dragon", "Guild Cross", "Hinoa", "Kamura Cloak", "Lance Gunn", "Minoto", "Orion", "Ran Page", "Summer", "Wild", "Expedition Headgear"]);
...
function renderArmorIndex(query) {
  ...
  const setMatches = (!q ? armorSets : armorSets.filter(s => normalizeSearch(s.name).includes(q)))
    .filter(s => !ARMOR_SET_HIDDEN.has(s.name.replace(/[αβγ]\s*/g, "").replace(/\s+Set$/, "").trim()));
...
const MONSTER_3D_MODELS = {
  ...
  "Conga": "data/models/conga.glb",
  "Blango": "data/models/blango.glb",
  "Ceratonoth": {
    variants: [
      { label: "Male", path: "data/models/ceratonoth-male.glb" },
      { label: "Female", path: "data/models/ceratonoth-female.glb" },
    ],
  },
  "Dalthydon": "data/models/dalthydon.glb",
  "Bulaqchi": "data/models/bulaqchi.glb",
  "Talioth": "data/models/talioth.glb",
  "Baunos": "data/models/baunos.glb",
  "Gajios": "data/models/gajios.glb",
  "Piragill": "data/models/piragill.glb",
  "Harpios": "data/models/harpios.glb",
  "Kranodath": "data/models/kranodath.glb",
  "Comaqchi": "data/models/comaqchi.glb",
  "Gelidron": "data/models/gelidron.glb",
  "Rafma": "data/models/rafma.glb",
  "Porkeplume": "data/models/porkeplume.glb",
  "Nerscylla Hatchling": "data/models/nerscylla-hatchling.glb",
  "Guardian Seikret": "data/models/guardian-seikret.glb",
};
