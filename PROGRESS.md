...
## Registro histórico: Armas y Armaduras (2026-08-07, superado por la sección funcional anterior)
...
- Esta lista describe el estado intermedio antes de la implementación funcional documentada arriba; no representa trabajo pendiente actual. Las limitaciones que siguen vigentes (sets sin match, íconos 404 y accesorios sin ranura) están enumeradas en la sección funcional y se muestran con fallback en la interfaz.
